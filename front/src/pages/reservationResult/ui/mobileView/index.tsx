...
import { Button, Icon, MobileBottomContainer, Separator } from '@/shared/components';
import { getDate, getPriceWon, getTime } from '@/shared/libs';

import { ALERT_MESSAGE_LIST } from '../../const';
import type { ViewProps } from '../../types';

export function MobileView({ name, runningDate, placeName, price, reservationList }: ViewProps) {
  return (
      ...
      <div className="flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-display1 text-primary">{getPriceWon(price * reservationList.length)}</span>
          </div>
        </div>
      </div>
      <Separator direction="row" />
